...
addr_b   dq 0.0 ; -18.0 ; 1.0  ; b
addr_a   dq 0.0 ; -3.14 ; 2.0  ; a
...
;        esp -> [addr_b][ret]
         ...
         fld qword [eax]  ; *(double*)eax = *(double*)addr_b = b -> st ; fpu load floating-point

;        st = [st0] = [b]  ; fpu stack

         fld qword [eax+8]  ; *(double*)(eax+8) = *(double*)addr_a = a -> st ; fpu load floating point
